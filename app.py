...
FUN_QUESTIONS = [
    # === 第一部分：日常习惯 ===
    {"id": "q1", "dimension": "ai_first_mindset", "category": "日常习惯",
     "question": "接到一个完全陌生领域的任务时，你通常会？",
     "options": [
         {"text": "先查资料，搞清楚基本概念再说", "score": {"ie": 40, "tf": 50, "pj": 50, "as": 60}, "tag": ""},
         {"text": "找个有经验的人问问", "score": {"ie": 30, "tf": 40, "pj": 40, "as": 40}, "tag": ""},
         {"text": "尝试用工具辅助，边做边摸索", "score": {"ie": 60, "tf": 60, "pj": 60, "as": 50}, "tag": ""},
         {"text": "先定个框架，然后分步解决", "score": {"ie": 50, "tf": 70, "pj": 70, "as": 50}, "tag": ""}]},
    {"id": "q2", "dimension": "deep_collaboration", "category": "日常习惯",
     "question": "当你需要向别人描述一个问题时，你的习惯是？",
     "options": [
         {"text": "想到什么说什么，比较随意", "score": {"ie": 30, "tf": 30, "pj": 30, "as": 40}, "tag": ""},
         {"text": "会把背景、目标、困难都讲清楚", "score": {"ie": 50, "tf": 60, "pj": 60, "as": 50}, "tag": ""},
         {"text": "会先整理一下思路再开口", "score": {"ie": 40, "tf": 50, "pj": 50, "as": 40}, "tag": ""},
         {"text": "会提供几个具体的例子让对方理解", "score": {"ie": 60, "tf": 50, "pj": 70, "as": 60}, "tag": ""}]},
    {"id": "q3", "dimension": "problem_reframing", "category": "日常习惯",
     "question": "遇到想不通的问题时，你一般会？",
     "options": [
         {"text": "先放一放，休息一下说不定就有思路了", "score": {"ie": 40, "tf": 40, "pj": 40, "as": 50}, "tag": ""},
         {"text": "换个角度重新审视这个问题", "score": {"ie": 60, "tf": 60, "pj": 60, "as": 50}, "tag": ""},
         {"text": "把大问题拆成小问题，一个个解决", "score": {"ie": 50, "tf": 50, "pj": 70, "as": 40}, "tag": ""},
         {"text": "找人讨论，碰撞一下思路", "score": {"ie": 50, "tf": 50, "pj": 50, "as": 60}, "tag": ""}]},
    {"id": "q4", "dimension": "learning_mode", "category": "日常习惯",
     "question": "需要快速学习一项新技能时，你习惯怎么学？",
     "options": [
         {"text": "找相关的视频教程跟着做", "score": {"ie": 50, "tf": 50, "pj": 60, "as": 50}, "tag": ""},
         {"text": "看官方文档，从基础开始", "score": {"ie": 40, "tf": 60, "pj": 50, "as": 40}, "tag": ""},
         {"text": "直接动手做项目，遇到问题再查", "score": {"ie": 60, "tf": 60, "pj": 70, "as": 50}, "tag": ""},
         {"text": "找一份学习清单，按计划推进", "score": {"ie": 40, "tf": 50, "pj": 60, "as": 40}, "tag": ""}]},
    {"id": "q5", "dimension": "iteration_agility", "category": "日常习惯",
     "question": "你平时关注新事物的频率是？",
     "options": [
         {"text": "很少主动关注，用到再说", "score": {"ie": 30, "tf": 40, "pj": 40, "as": 40}, "tag": ""},
         {"text": "偶尔看看热门话题", "score": {"ie": 40, "tf": 40, "pj": 40, "as": 50}, "tag": ""},
         {"text": "会定期浏览行业动态", "score": {"ie": 50, "tf": 50, "pj": 50, "as": 50}, "tag": ""},
         {"text": "经常尝试新工具新产品", "score": {"ie": 60, "tf": 60, "pj": 60, "as": 50}, "tag": ""}]},
    # === 第二部分：工作风格 ===
    {"id": "q6", "dimension": "boundary_awareness", "category": "工作风格",
     "question": "收到一份专业报告或方案时，你会怎么做？",
     "options": [
         {"text": "直接看结论和建议", "score": {"ie": 30, "tf": 40, "pj": 50, "as": 40}, "tag": ""},
         {"text": "先快速浏览，有用的再细读", "score": {"ie": 40, "tf": 50, "pj": 50, "as": 50}, "tag": ""},
         {"text": "核对一下数据和来源是否可靠", "score": {"ie": 50, "tf": 60, "pj": 60, "as": 60}, "tag": ""},
         {"text": "多方验证，确保没有问题再使用", "score": {"ie": 50, "tf": 70, "pj": 60, "as": 70}, "tag": ""}]},
    {"id": "q7", "dimension": "ai_first_mindset", "category": "工作风格",
     "question": "你更喜欢什么样的工作方式？",
     "options": [
         {"text": "按部就班，一步步完成任务", "score": {"ie": 40, "tf": 40, "pj": 50, "as": 50}, "tag": ""},
         {"text": "一次专注做好一件事", "score": {"ie": 40, "tf": 50, "pj": 50, "as": 50}, "tag": ""},
         {"text": "同时处理多项任务，保持高效运转", "score": {"ie": 50, "tf": 50, "pj": 60, "as": 40}, "tag": ""},
         {"text": "用系统化的方式提高效率", "score": {"ie": 50, "tf": 60, "pj": 70, "as": 50}, "tag": ""}]},
    {"id": "q8", "dimension": "deep_collaboration", "category": "工作风格",
     "question": "你和同事协作时，通常扮演什么角色？",
     "options": [
         {"text": "做好自己负责的部分就行", "score": {"ie": 40, "tf": 40, "pj": 40, "as": 40}, "tag": ""},
         {"text": "主动分享信息和资源", "score": {"ie": 50, "tf": 50, "pj": 50, "as": 50}, "tag": ""},
         {"text": "帮忙协调进度，推动项目进展", "score": {"ie": 50, "tf": 50, "pj": 60, "as": 50}, "tag": ""},
         {"text": "统筹全局，制定协作流程", "score": {"ie": 50, "tf": 60, "pj": 70, "as": 50}, "tag": ""}]},
    {"id": "q9", "dimension": "deep_collaboration", "category": "工作风格",
     "question": "你会把工作中的心得体会分享给朋友吗？",
     "options": [
         {"text": "很少，除非别人主动问", "score": {"ie": 30, "tf": 40, "pj": 40, "as": 40}, "tag": ""},
         {"text": "遇到好的方法会顺便提一下", "score": {"ie": 40, "tf": 50, "pj": 50, "as": 50}, "tag": ""},
         {"text": "觉得有用就会主动分享", "score": {"ie": 50, "tf": 50, "pj": 50, "as": 50}, "tag": ""},
         {"text": "经常分享，还会推荐别人一起用", "score": {"ie": 60, "tf": 50, "pj": 60, "as": 50}, "tag": ""}]},
    {"id": "q10", "dimension": "learning_mode", "category": "工作风格",
     "question": "你给别人介绍一个工具或方法时，会怎么说？",
     "options": [
         {"text": "直接告诉名字，让他们自己研究", "score": {"ie": 30, "tf": 40, "pj": 40, "as": 40}, "tag": ""},
         {"text": "简单说一下是干什么用的", "score": {"ie": 40, "tf": 40, "pj": 40, "as": 50}, "tag": ""},
         {"text": "会说清楚使用场景和效果", "score": {"ie": 50, "tf": 50, "pj": 50, "as": 50}, "tag": ""},
         {"text": "会详细讲解使用方法和注意事项", "score": {"ie": 50, "tf": 60, "pj": 60, "as": 50}, "tag": ""}]},
    # === 第三部分：生活态度 ===
    {"id": "q11", "dimension": "ai_first_mindset", "category": "生活态度",
     "question": "周末要组织一次朋友聚会，你会？",
     "options": [
         {"text": "问问大家想去哪，一起商量", "score": {"ie": 40, "tf": 40, "pj": 40, "as": 50}, "tag": ""},
         {"text": "根据大家的偏好做调研再推荐", "score": {"ie": 50, "tf": 50, "pj": 60, "as": 50}, "tag": ""},
         {"text": "直接定个地方，不纠结", "score": {"ie": 40, "tf": 50, "pj": 50, "as": 40}, "tag": ""},
         {"text": "做一个对比表，让选择更清晰", "score": {"ie": 50, "tf": 60, "pj": 70, "as": 60}, "tag": ""}]},
    {"id": "q12", "dimension": "iteration_agility", "category": "生活态度",
     "question": "听说有一个新东西很火，你的反应是？",
     "options": [
         {"text": "等等看，过段时间再说", "score": {"ie": 30, "tf": 40, "pj": 40, "as": 40}, "tag": ""},
         {"text": "了解一下是什么，确认有用了再试", "score": {"ie": 40, "tf": 50, "pj": 50, "as": 50}, "tag": ""},
         {"text": "先体验一下再说", "score": {"ie": 50, "tf": 50, "pj": 60, "as": 50}, "tag": ""},
         {"text": "马上试用，还会分享给朋友", "score": {"ie": 60, "tf": 50, "pj": 60, "as": 50}, "tag": ""}]},
    {"id": "q13", "dimension": "problem_reframing", "category": "生活态度",
     "question": "你曾经用一种很特别的方式解决过什么问题吗？",
     "options": [
         {"text": "好像没有，生活比较常规", "score": {"ie": 30, "tf": 30, "pj": 30, "as": 40}, "tag": ""},
         {"text": "偶尔会想出一些讨巧的办法", "score": {"ie": 40, "tf": 40, "pj": 50, "as": 50}, "tag": ""},
         {"text": "经常能找到省时省力的解决方案", "score": {"ie": 50, "tf": 50, "pj": 60, "as": 50}, "tag": ""},
         {"text": "经常能想到别人想不到的方法", "score": {"ie": 60, "tf": 50, "pj": 60, "as": 60}, "tag": ""}]},
    {"id": "q14", "dimension": "boundary_awareness", "category": "生活态度",
     "question": "你有没有发现过一些信息来源不太可靠？",
     "options": [
         {"text": "很少注意到这类问题", "score": {"ie": 30, "tf": 30, "pj": 30, "as": 40}, "tag": ""},
         {"text": "有时候会怀疑一下", "score": {"ie": 40, "tf": 40, "pj": 40, "as": 50}, "tag": ""},
         {"text": "会核实一下，确保信息准确", "score": {"ie": 50, "tf": 60, "pj": 60, "as": 60}, "tag": ""},
         {"text": "会主动验证，找出错误信息", "score": {"ie": 50, "tf": 70, "pj": 60, "as": 70}, "tag": ""}]},
    # === 第四部分：思维方式 ===
    {"id": "q15", "dimension": "ai_first_mindset", "category": "思维方式",
     "question": "如果你的工作方式突然被改变了，你会？",
     "options": [
         {"text": "有点不适应，需要时间调整", "score": {"ie": 40, "tf": 40, "pj": 40, "as": 50}, "tag": ""},
         {"text": "先看看新方式有什么好处", "score": {"ie": 50, "tf": 50, "pj": 50, "as": 50}, "tag": ""},
         {"text": "快速适应，看看能怎么用好它", "score": {"ie": 60, "tf": 60, "pj": 60, "as": 50}, "tag": ""},
         {"text": "思考如何让它发挥最大效果", "score": {"ie": 50, "tf": 70, "pj": 70, "as": 50}, "tag": ""}]},
    {"id": "q16", "dimension": "iteration_agility", "category": "思维方式",
     "question": "你一天中最有创造力的时段是？",
     "options": [
         {"text": "早上，刚睡醒脑子清醒", "score": {"ie": 40, "tf": 50, "pj": 50, "as": 50}, "tag": ""},
         {"text": "下午，处理常规工作的时间", "score": {"ie": 40, "tf": 40, "pj": 50, "as": 40}, "tag": ""},
         {"text": "晚上，夜深人静时灵感多", "score": {"ie": 50, "tf": 50, "pj": 50, "as": 60}, "tag": ""},
         {"text": "不固定，有灵感了就抓紧做", "score": {"ie": 60, "tf": 50, "pj": 50, "as": 50}, "tag": ""}]},
    {"id": "q17", "dimension": "deep_collaboration", "category": "思维方式",
     "question": "你觉得什么东西在未来会有大变化？",
     "options": [
         {"text": "好像都差不多吧", "score": {"ie": 30, "tf": 30, "pj": 30, "as": 40}, "tag": ""},
         {"text": "一些重复性的工作会被机器替代", "score": {"ie": 40, "tf": 50, "pj": 50, "as": 50}, "tag": ""},
         {"text": "很多行业的工作方式都会改变", "score": {"ie": 50, "tf": 50, "pj": 60, "as": 50}, "tag": ""},
         {"text": "很多事情会被重新定义", "score": {"ie": 50, "tf": 60, "pj": 60, "as": 50}, "tag": ""}]},
    {"id": "q18", "dimension": "boundary_awareness", "category": "思维方式",
     "question": "你有没有过突然想通一个问题的经历？",
     "options": [
         {"text": "很少有这种感觉", "score": {"ie": 30, "tf": 40, "pj": 40, "as": 40}, "tag": ""},
         {"text": "偶尔会有", "score": {"ie": 40, "tf": 50, "pj": 50, "as": 50}, "tag": ""},
         {"text": "经常会有这样的时刻", "score": {"ie": 50, "tf": 50, "pj": 60, "as": 50}, "tag": ""},
         {"text": "经常从不同角度思考问题", "score": {"ie": 60, "tf": 60, "pj": 60, "as": 50}, "tag": ""}]},
    {"id": "q19", "dimension": "problem_reframing", "category": "思维方式",
     "question": "如果用一个词形容你的工作风格，你会选？",
     "options": [
         {"text": "稳定", "score": {"ie": 40, "tf": 40, "pj": 50, "as": 50}, "tag": ""},
         {"text": "高效", "score": {"ie": 50, "tf": 50, "pj": 60, "as": 50}, "tag": ""},
         {"text": "灵活", "score": {"ie": 50, "tf": 50, "pj": 50, "as": 60}, "tag": ""},
         {"text": "创新", "score": {"ie": 60, "tf": 60, "pj": 60, "as": 50}, "tag": ""}]},
    {"id": "q20", "dimension": "learning_mode", "category": "思维方式",
     "question": "你给自己现在的状态打几分（满分10分）？",
     "options": [
         {"text": "6分以下，还有很多要改进的", "score": {"ie": 40, "tf": 40, "pj": 40, "as": 50}, "tag": ""},
         {"text": "7分，还不错", "score": {"ie": 50, "tf": 50, "pj": 50, "as": 50}, "tag": ""},
         {"text": "8-9分，状态挺好的", "score": {"ie": 50, "tf": 50, "pj": 60, "as": 50}, "tag": ""},
         {"text": "10分，我很满意现在的状态", "score": {"ie": 60, "tf": 50, "pj": 60, "as": 50}, "tag": ""}]}
]
...
def render_personal_version():
    ...
    # ===== 测试阶段 =====
        ...
        categories = ["日常习惯", "工作风格", "生活态度", "思维方式"]
